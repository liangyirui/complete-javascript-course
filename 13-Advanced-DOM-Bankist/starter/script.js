...
btnScrollTo.addEventListener('click', function (e) {
  ...
  // Modern way to control scrolling
...
// Passing "argument" into handler, use bind() which returns a new function
// the this keyword always binds to the argument passes to bind()
...
//   // make the navigation sticky when reach section 1
...
// console.log(document.getElementsByClassName('btn')); // return live html collection

// // Creating and inserting elements
// // *important* .insertAdjacentHTML
...
// // Don't use, will overwrite all existing classes and only one class
...
// Outdated way, does not allow multiple listener, does not allow removal
